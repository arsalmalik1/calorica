...
import 'package:calorica/pages/wishlist/wishlist_app_bar.dart';
...
import '../days/day_meal_product_card.dart';
import '../wishlist/wishlist_meal_product_details.dart';

typedef void StringCallback(String val);

// ignore: must_be_immutable
class WishlistMealDetails extends StatefulWidget {
  String _date;
  WishlistMealDetails({String date, this.dashMeal, this.onDelete})
      : _date = date;
  DashMeal dashMeal;
  Function onDelete;
  @override
  _WishlistMealDetailsState createState() => _WishlistMealDetailsState(_date);
}

class _WishlistMealDetailsState extends State<WishlistMealDetails> {
  String date;
  _WishlistMealDetailsState(this.date);
  var intDate;
